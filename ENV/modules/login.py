...
def render_login():
    ...
    # Si ya hay sesión activa, no volvemos a consultar Supabase
    if st.session_state.get("trabajadorid"):
        st.success(f"Sesión activa: {st.session_state.get('user_nombre', st.session_state.get('user_email',''))}")
